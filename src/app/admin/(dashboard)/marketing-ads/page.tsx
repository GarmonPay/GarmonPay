  ...
  return (
    <div className="py-6 space-y-8">
      <div className="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
        <div>
        <h1 className="text-xl font-bold text-white mb-2">Marketing ads</h1>
        <p className="text-fintech-muted">
          Site marketing placements (homepage, dashboard, arena) — not the watch &amp; earn video feed.
          Upload banner images or videos, set destination URL and placement.
        </p>
        </div>
      </div>
