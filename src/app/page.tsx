        ...
        <section className="relative flex min-h-[92vh] flex-col items-center justify-center px-4 pb-24 pt-28 text-center">
          ...
          <div className="relative z-10 max-w-4xl">
            ...
            <p className="mx-auto mt-8 max-w-xl text-base text-violet-200/90 sm:text-lg">
              ...
              purple-and-gold ecosystem built for real earners.
            </p>
            <div className="mt-10 flex flex-wrap items-center justify-center gap-4">
              <Link
                href="/register"
                className="rounded-xl bg-gradient-to-r from-violet-600 to-violet-500 px-8 py-3.5 text-base font-semibold text-white shadow-lg shadow-violet-900/40 transition hover:from-violet-500 hover:to-violet-400"
              >
                Start Earning Free
              </Link>
              <Link
