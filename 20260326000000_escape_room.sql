-- Stake & Escape game schema (reference copy).
-- Source of truth for `supabase db push` / CI: supabase/migrations/20260326120000_escape_room.sql
-- Keep this file in sync manually if you edit the migration, or delete this duplicate to avoid drift.
